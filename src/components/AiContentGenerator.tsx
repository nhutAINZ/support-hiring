...
export default function AiContentGenerator({ savedGroups = [], onAddGroup }: AiContentGeneratorProps) {
  ...
  const handleGeneratePoster = async () => {
    ...
    setPosterError(null);
    try {
      const res = await fetchApi("/api/gemini/generate-poster", {
         method: "POST",
  ...
  const handleParseJd = async () => {
    ...
    setParsingJd(true);
    try {
      const res = await fetchApi("/api/gemini/parse-jd", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const contentRes = await fetchApi("/api/gemini/generate-content", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      ...
      const groupsRes = await fetchApi("/api/gemini/suggest-groups", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
